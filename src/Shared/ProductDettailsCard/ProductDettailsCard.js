      ...
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="flex justify-center items-center">
          <img
            ...
            src="https://pixner.net/sbidu/main/assets/images/product/product1.png"
        ...
        <div className=" my-10  ">
          <div className=" border border-black  flex flex-col  lg:flex-row justify-between items-center  w-full text-left ">
            <div className="border w-full mx-2">
              <div>
                <h2 className="max-w-xl mt-1 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                  The Breeze Zodiac IX
                </h2>
                <span>
                  Listing ID: <span>14076242</span>
                </span>
              </div>
              <div className="my-6 px-5 bg-slate-200   rounded-lg  shadow-2xl w-full   py-10 ">
                <h2 className="text-2xl flex justify-between font-semibold mb-2 flex-col lg:flex-row items-center  ">
                  <span>Current Bid :</span>
                  <span className="text-green-600">550 $</span>
                </h2>
                <h2 className="text-2xl flex justify-between font-semibold mb-2 flex-col lg:flex-row items-center">
                  <span>This Auction Ends in:</span>
                  <span className="text-red-500">0d : 6h : 21m : 26s</span>
                </h2>
              </div>
