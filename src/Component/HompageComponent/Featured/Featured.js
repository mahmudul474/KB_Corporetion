  ...
  return (
    ...
    >
      ...
      <div className="text-left  my-5">
        ...
        <h3 className="text-lg text-gray-400">Start winning cars with comfort</h3>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5 ">
        {futureds?.slice(0, 3).map((futured) => (
          <div className="card px-2 bg-base-100 shadow-xl">
            ...
            <div className="card-body py-5 items-center text-left px-3">
              <h2 className="card-title text-xl  capitalize my-3 font-semibold">{futured.title}</h2>
        ...
        <h2 className="text-green-600">{futured.CurentBid}  Bids</h2>
              ...
              <div class="mb-4">
                <button type="button" className='flex justify-center items-center max-w-sm w-full bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 focus:outline-none text-white text-xl uppercase shadow-md rounded-lg mx-auto p-2'>
                    Submit A Bid    
                </button>
            </div>
              </div>
      ...
      <div className="my-10">
        <button className="m-auto btn bg-transparent border  p-5 rounded-md text-lg  font-semibold capitalize border-green-600"> View All </button>
      </div>
      </div> 
    </div>
  );
