...
<div className="px-4 py-16 mx-auto sm:max-w-xl  md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="felx text-left justify-start items-start  my-3">
        <h1 className="capitalize  text-left text-3xl font-bold  text-black ">Cold Rolled Products</h1>
        <p className="text-lg leading-loose text-black " >Introduction of item</p>
        <h4>
        Cold-rolled products are high-quality steel products with beautiful surfaces and excellent workability.
It is an essential material in a modern society that is diversifying day by day due to the improvement of consumer life.
        </h4>
      </div>
