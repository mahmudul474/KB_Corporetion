    ...
    <div className="text-black ">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl  md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="felx text-left justify-start items-start  my-3">
          <h1 className="capitalize  text-left text-3xl font-bold  text-black ">
            hot rolled product
          </h1>
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                ...
                <p className="text-base text-gray-700 md:text-lg">
                  For cold-rolled steel sheets, scale generated on the surface
                  of hot-rolled coils is removed with hydrochloric acid or
                  sulfuric acid in the pickling process, and after rolling
                  thinly with rolling rolls, It is a product that has the
                  thickness and mechanical properties required by customers by
                  undergoing annealing heat treatment.
                </p>
              </div>
                ...
                <div className="max-w-md  sm:mx-auto sm:text-center ">
                  ...
                  <div className="flex flex-col lg:items-center items-start">
                    ...
                    <p className="mb-3 text-left lg:text-center  text-sm text-gray-900">
                      used for general purpose As a steel material, home
                      appliances, drums, furniture manufacturing, etc.
                    </p>
                  </div>
                </div>
                <div className="max-w-md  sm:mx-auto sm:text-center ">
                  ...
                  <div className="flex flex-col lg:items-center items-start">
                    ...
                    <p className="mb-3 text-left lg:text-center  text-sm text-gray-900">
                      Cold-rolled steel has a beautiful surface and good
                      workability. From household items such as refrigerators
                      and washing machines, From industrial equipment to various
                      construction materials and automobiles It is used for
                      various purposes and according to the advancement of
                      industrial structure It is in the limelight as an
                      essential material in modern society
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid px-4   py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:grid-cols-3 grid-cols-1 md:grid-cols-2 gap-10 ">
          <img className="h-auto max-w-lg rounded-lg" src={img1} alt="img" />

          <img
            className="h-auto max-w-lg  lg:-mt-20 rounded-lg"
            src={img2}
            alt="img"
          />

          <img className="h-auto max-w-lg rounded-lg" src={img3} alt="img" />
        </div>
      </div>
    </div>
  );
