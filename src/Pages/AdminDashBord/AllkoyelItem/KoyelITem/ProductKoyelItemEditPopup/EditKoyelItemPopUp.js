  ...
  return (
    <div className="fixed z-50 inset-0 flex items-center justify-center ">
      <div className="shadow-2xl bg-white rounded-lg p-8">
        <h2 className="mb-5 text-xl text-[#719f18]">Edit Product item</h2>
        <form onSubmit={handleUpadeteProduct}>
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
              ...
              <label
                for="minimumBid"
                className="peer-focus:font-medium absolute  text-sm text-black  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] left-0 peer-focus:left-0  peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >
                Minimum Bid
              </label>
            </div>
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                onBlur={e => setStartBiddingTime(e.target.value)}
                type="datetime-local"
                id="startBiddingTime"
                name="startBiddingTime"
                className="block py-2.5 px-0 w-full text-sm text-black  border-0 border-b-2 border-gray-300 appearance-none   dark:text-white focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" "
                required
              />
              <label
            ...
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                onBlur={e => setEndBiddingTime(e.target.value)}
                type="datetime-local"
                id="endBiddingTime"
                name="endBiddingTime"
                className="block py-2.5 px-0 w-full text-sm text-black  dark:text-white  border-0 border-b-2 border-gray-300 appearance-none     focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" "
                required
              />
              <label
                for="endBiddingTime"
                className="peer-focus:font-medium absolute  text-sm text-black dark:text-white  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] left-0 peer-focus:left-0 peer-focus:text-blue-600    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >
                End-Bidding-Time
              </label>
            </div>
          ...
          <button
            type="submit"
            className="text-white my-4 bg-[#719f18] hover:bg-[#73471b] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600  "
          >
            Update
          </button>
          <button
            onClick={onClose}
            className="btn   border-none bg-[#719f18] p-2 text-white font-semibold rounded-md ml-3"
          >
            Cancel
          </button>
        </form>
...
export default EditKoyelItemPopUp;
