            ...
            <div class="w-full px-4 md:w-1/2 ">
              <div class="lg:pl-20">
                ...
                <div className="flex  justify-between  text-lg  text-black    ">
                    <span className=" text-sm text-black  font-semibold  dark:text-black">Per Ton price:</span>
                    <span className=" text-sm text-black  font-semibold  dark:text-black">{data?.startBiddingPrice} $</span>
                  </div>
                  <div className="flex  justify-between items-center   text-lg  text-black    ">
                    <span className=" text-sm text-black  font-semibold  dark:text-black">Current bidding Price:</span>
