    ...
    <div className="text-black ">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl  md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="felx text-left justify-start items-start  my-3">
          ...
          <h4>
            Cold-rolled products are high-quality steel products with beautiful
            surfaces and excellent workability. It is an essential material in a
            modern society that is diversifying day by day due to the
            improvement of consumer life.
          </h4>
        </div>
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                ...
                <p className="text-base text-gray-700 md:text-lg">
                  ...
                  Through this, we make steel plates for automobiles, steel
              ...
              <div className="grid gap-8 row-gap-10 lg:grid-cols-2">
                ...
                <div className="max-w-md  sm:mx-auto sm:text-center ">
                  ...
                  <div className="flex flex-col lg:items-center items-start">
                    ...
                    <p className="mb-3 text-left lg:text-center  text-sm text-gray-900">
                      Heat the material to a high temperature Because the
                      material is produced at the recrystallization temperature
                      point Can speed up production
                    </p>
                  </div>
                </div>
              </div>
